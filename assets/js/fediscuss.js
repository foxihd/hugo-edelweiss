...
#comments ul > li {border-radius:1ex;overflow:clip}
#comments ul ul {margin-left:2rem}
...
.fed-comments {margin:1.6rem 0;border-left:3pt solid var(--ac);background:#faf0e633;padding:1pc;overflow:auto}
.fed-comments > header,.fed-comments > footer {display:flex;align-items:center;overflow-x:auto;white-space:nowrap;gap:1rem}
.fed-comments time {font:0.9rem monospace}
...
a.date,.stat a {opacity:0.5;margin:0 2pt;color:inherit;font-size:var(--small)}
.author a {color:var(--fg);}
.stat a.active {opacity:1;color:var(--ac)}
.stat .favourites.active{color:red}
.has-aria-label::after{display:block;margin:auto;color:var(--mid);font:0.7em monospace;content:attr(aria-label)}
...
@media (min-width: 641px) {.fed-comments .content {padding-left: 46pt}}
`;
